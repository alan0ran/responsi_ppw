...
<body>
    ...
    <?php
    include 'db.php';
    $mysqli = mysqli_query($database,"SELECT * FROM inventory ");
    $number = 1;
    $total = 0;
    ...
    ?>
        <tr>
            ...
            <td><?php echo "Rp. ".$price_format ?></td>
            <td><?php echo "Rp. ". $amount_format?></td>

            <td><a href="edit.php?item_id=<?=$data['item_id']?>" class="btn btn-primary">Edit</a></td>
            <td><a href="delete.php?item_id=<?=$data['item_id']?>" class="btn btn-primary">Delete</a></td>
        </tr>
    <?php 
    $total += $price;
